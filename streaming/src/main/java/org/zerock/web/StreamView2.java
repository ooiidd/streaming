...
public class StreamView2 extends AbstractView{
	private static final Logger logger = LoggerFactory.getLogger(StreamView2.class);
	private String movieDir = "movie";
	
	@Override
	@RequestMapping(value="/movies/{video_name}",method=RequestMethod.GET)
